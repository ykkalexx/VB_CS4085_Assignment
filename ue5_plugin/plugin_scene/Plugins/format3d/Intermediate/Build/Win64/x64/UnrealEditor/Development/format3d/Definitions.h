...
#define UE_PROJECT_NAME plugin_scene
#define UE_TARGET_NAME plugin_sceneEditorNonUnity
#define UE_MODULE_NAME "format3d"
#define UE_PLUGIN_NAME "format3d"
